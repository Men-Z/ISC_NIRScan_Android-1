...
public class StoredScanDataActivity extends Activity {
    ...
    private final IntentFilter storedScanFilter = new IntentFilter(NIRScanSDK.STORED_SCAN_DATA);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalBroadcastManager.getInstance(mContext).sendBroadcast(new Intent(NIRScanSDK.GET_STORED_SCANS));
        ...
        storedScanSizeReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                storedScanSize = intent.getIntExtra(NIRScanSDK.EXTRA_INDEX_SIZE, 0);
                if (storedScanSize > 0) {
                    ...
                    barProgressDialog.setMax(intent.getIntExtra(NIRScanSDK.EXTRA_INDEX_SIZE, 0));
        ...
        LocalBroadcastManager.getInstance(mContext).registerReceiver(storedScanSizeReceiver, new IntentFilter(NIRScanSDK.SD_SCAN_SIZE));
    ...
    private class StoredScanReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            storedScanList.add(new StoredScan(intent.getStringExtra(NIRScanSDK.EXTRA_SCAN_NAME), createTimeString(scanDate), intent.getByteArrayExtra(NIRScanSDK.EXTRA_SCAN_INDEX)));
            ...
            lv_stored_scans.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(final int position, SwipeMenu menu, int index) {
                    ...
                    switch (index) {
                        case 0:
                            Intent deleteScanIntent = new Intent(NIRScanSDK.DELETE_SCAN);
                            deleteScanIntent.putExtra(NIRScanSDK.EXTRA_SCAN_INDEX, storedScanAdapter.getItem(position).getScanIndex());
     ...
     * {@link com.isctechnologies.NanoScan.StoredScanDataActivity.StoredScan} objects and initializes
     * the view holder
     */
     ...
     * {@link com.isctechnologies.NanoScan.StoredScanDataActivity.StoredScan} object
     */
    ...
    private SwipeMenuCreator createMenu() {
        return new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                // set item background
                settingsItem.setBackground(R.color.red);
                // set item width
