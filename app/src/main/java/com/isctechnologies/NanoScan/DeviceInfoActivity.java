    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInfoReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                tv_manuf.setText(intent.getStringExtra(NIRScanSDK.EXTRA_MANUF_NAME).replace("\n", ""));
                tv_model.setText(intent.getStringExtra(NIRScanSDK.EXTRA_MODEL_NUM).replace("\n", ""));
                tv_serial.setText(intent.getStringExtra(NIRScanSDK.EXTRA_SERIAL_NUM));
                tv_hw.setText(intent.getStringExtra(NIRScanSDK.EXTRA_HW_REV));
                tv_tiva.setText(intent.getStringExtra(NIRScanSDK.EXTRA_TIVA_REV));
                tv_spec.setText(intent.getStringExtra(NIRScanSDK.EXTRA_SPECTRUM_REV));
