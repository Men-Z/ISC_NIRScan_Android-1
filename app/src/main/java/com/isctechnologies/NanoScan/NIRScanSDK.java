...
public class NIRScanSDK {
    private static final String TAG = "NIRScanSDK";
    ...
    public static NIRScanSDK.ScanResults NIRScanSDK_dlpSpecScanInterpReference(byte[] data, byte[] coeff, byte[] matrix) {
        return (NIRScanSDK.ScanResults)dlpSpecScanInterpReference(data, coeff, matrix);
    }

    public static NIRScanSDK.ScanConfiguration NIRScanSDK_dlpSpecScanReadConfiguration(byte[] data) {
        return (NIRScanSDK.ScanConfiguration)dlpSpecScanReadConfiguration(data);
    }*/

    private static boolean characteristicError() {
        if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISHardwareRev == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_HW_REV.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISManufName == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_MANUF_NAME.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISModelNumber == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_MODEL_NUMBER.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISSerialNumber == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_SERIAL_NUMBER.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISSpectrumCRev == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_SPECC_REV.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharDISTivaFirmwareRev == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.DIS_TIVA_FW_REV.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharBASBattLevel == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.BAS_BATT_LVL.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISBatteryRechargeCycles == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_NUM_BATT_RECHARGE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISDevStatus == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_DEV_STATUS.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISErrorStatus == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_ERR_STATUS.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISHoursOfUse == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_HOURS_OF_USE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISHumidMeasurement == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_HUMID_MEASUREMENT.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISHumidThreshold == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_HUMID_THRESH.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISLampHours == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_LAMP_HOURS.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISTempMeasurement == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_TEMP_MEASUREMENT.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGGISTempThreshold == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GGIS_TEMP_THRESH.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGDTSTime == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GDTS_TIME.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGCISReqRefCalCoefficients == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GCIS_REQ_REF_CAL_COEFF.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGCISReqRefCalMatrix == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GCIS_REQ_REF_CAL_MATRIX.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGCISReqSpecCalCoefficients == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GCIS_REQ_SPEC_CAL_COEFF.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGCISRetRefCalCoefficients == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GCIS_RET_REF_CAL_COEFF.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGCISRetRefCalMatrix == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GCIS_RET_REF_CAL_MATRIX.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISActiveScanConf == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_ACTIVE_SCAN_CONF.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISNumberStoredConf == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_NUM_STORED_CONF.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISReqScanConfData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_REQ_SCAN_CONF_DATA.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISReqStoredConfList == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_REQ_STORED_CONF_LIST.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISRetScanConfData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_RET_SCAN_CONF_DATA.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSCISRetStoredConfList == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSCIS_RET_STORED_CONF_LIST.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISNumberSDStoredScans == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_NUM_SD_STORED_SCANS.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISSDStoredScanIndicesList == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_SD_STORED_SCAN_IND_LIST.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISSDStoredScanIndicesListData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_SD_STORED_SCAN_IND_LIST_DATA.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISSetScanNameStub == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_SET_SCAN_NAME_STUB.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISStartScanWrite == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_START_SCAN.toString() + " (Write)");
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISStartScanNotify == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_START_SCAN.toString() + " (Notify)");
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISClearScanWrite == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_CLEAR_SCAN.toString() + " (Write)");
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISClearScanNotify == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_CLEAR_SCAN.toString() + " (Notify)");
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISReqScanName == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_REQ_SCAN_NAME.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISRetScanName == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_RET_SCAN_NAME.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISReqScanType == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_REQ_SCAN_TYPE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISRetScanType == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_RET_SCAN_TYPE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISReqScanDate == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_REQ_SCAN_DATE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISRetScanDate == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_RET_SCAN_DATE.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISReqPacketFormatVersion == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_REQ_PKT_FMT_VER.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISRetPacketFormatVersion == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_RET_PKT_FMT_VER.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISReqSerialScanDataStruct == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_REQ_SER_SCAN_DATA_STRUCT.toString());
            return true;
        } else if(NIRScanSDK.NanoGattCharacteristic.mBleGattCharGSDISRetSerialScanDataStruct == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NIRScanSDK.NanoGATT.GSDIS_RET_SER_SCAN_DATA_STRUCT.toString());
            return true;
        } else if(NanoGattCharacteristic.mBleGattCharacteristicCharacteristicActivateState == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NanoGATT.GSDIS_ACTIVATE_STATE.toString());
            return true;
        } else if(NanoGattCharacteristic.mBleGattCharacteristicCharacteristicActivateStateNotify == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NanoGATT.GSDIS_RETURN_ACTIVATE_STATE.toString());
            return true;
        }else if(NanoGattCharacteristic.mBleGattCharacteristicReadCurrentScanConfigurationData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NanoGATT.GSDIS_READ_CURRENT_SCANCONFIG_DATA.toString());
            return true;
        } else if(NanoGattCharacteristic.mBleGattCharacteristicReturnCurrentScanConfigurationData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NanoGATT.GSDIS_RETURN_CURRENT_SCANCONFIG_DATA.toString());
            return true;
        }else if(NanoGattCharacteristic.mBleGattCharacteristicWriteScanConfigurationData == null) {
            Log.e("NIRScanSDK", "Failed to enumerate UUID:" + NanoGATT.GSDIS_WRITE_SCANCONFIG_DATA.toString());
            return true;
    ...
    public static void writeCharacteristic(BluetoothGattCharacteristic characteristic, byte[] data) {
        if(characteristic == null) {
            Log.e("NIRScanSDK", "Error writing NULL characteristic");
        } else {
            characteristic.setValue(data);
            if(mBluetoothAdapter != null && mBluetoothGatt != null) {
                mBluetoothGatt.writeCharacteristic(characteristic);
            } else {
                Log.e("NIRScanSDK", "ERROR: mBluetoothAdapter is null");
            }
        }
    }
    ...
    public static void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        if(mBluetoothAdapter != null && mBluetoothGatt != null) {
            if(characteristic != null) {
                ...
                Log.e("NIRScanSDK", "ERROR: Reading NULL characteristic");
            }
    ...
    public static class ReferenceCalibration implements Serializable {
        ...
        public static ArrayList<NIRScanSDK.ReferenceCalibration> currentCalibration;
        ...
        public static boolean writeRefCalFile(Context context, ArrayList<NIRScanSDK.ReferenceCalibration> list) {
