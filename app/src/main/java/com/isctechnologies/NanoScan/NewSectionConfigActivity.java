...
public class NewSectionConfigActivity extends Activity {
    ...
    private void init_EditText_Spec_Start()
    {
        ...
        for(int i=0;i<et_spec_start.size();i++)
        {
            ...
            init_start_nm[i] = (Integer.parseInt(et_spec_start.get(i).getText().toString()));
        }
    ...
    private void init_EditText_Spec_End()
    {
        ...
        for(int i=0;i<et_spec_end.size();i++)
        {
            ...
            init_end_nm[i] = (Integer.parseInt(et_spec_end.get(i).getText().toString()));
        }
    ...
    private EditText.OnEditorActionListener section1_spec_start = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_start.get(0).getText().toString().matches("")|| Integer.parseInt(et_spec_start.get(0).getText().toString())> Integer.parseInt(et_spec_end.get(0).getText().toString()) || Integer.parseInt(et_spec_start.get(0).getText().toString())<900)
                {
    ...
    private EditText.OnEditorActionListener section2_spec_start = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_start.get(1).getText().toString().matches("")|| Integer.parseInt(et_spec_start.get(1).getText().toString())> Integer.parseInt(et_spec_end.get(1).getText().toString()) || Integer.parseInt(et_spec_start.get(1).getText().toString())<900)
                {
    ...
    private EditText.OnEditorActionListener section3_spec_start = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_start.get(2).getText().toString().matches("")|| Integer.parseInt(et_spec_start.get(2).getText().toString())> Integer.parseInt(et_spec_end.get(2).getText().toString()) || Integer.parseInt(et_spec_start.get(2).getText().toString())<900)
                {
    ...
    private EditText.OnEditorActionListener section4_spec_start = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_start.get(3).getText().toString().matches("")|| Integer.parseInt(et_spec_start.get(3).getText().toString())> Integer.parseInt(et_spec_end.get(3).getText().toString()) || Integer.parseInt(et_spec_start.get(3).getText().toString())<900)
                {
    ...
    private EditText.OnEditorActionListener section5_spec_start = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_start.get(4).getText().toString().matches("")|| Integer.parseInt(et_spec_start.get(4).getText().toString())> Integer.parseInt(et_spec_end.get(4).getText().toString()) || Integer.parseInt(et_spec_start.get(4).getText().toString())<900)
                {
    ...
    private EditText.OnEditorActionListener section1_spec_end = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_end.get(0).getText().toString().matches("")|| Integer.parseInt(et_spec_end.get(0).getText().toString())< Integer.parseInt(et_spec_start.get(0).getText().toString()) || Integer.parseInt(et_spec_end.get(0).getText().toString())>1700)
                {
    ...
    private EditText.OnEditorActionListener section2_spec_end = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_end.get(1).getText().toString().matches("")|| Integer.parseInt(et_spec_end.get(1).getText().toString())< Integer.parseInt(et_spec_start.get(1).getText().toString()) || Integer.parseInt(et_spec_end.get(1).getText().toString())>1700)
                {
    ...
    private EditText.OnEditorActionListener section3_spec_end = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_end.get(2).getText().toString().matches("")|| Integer.parseInt(et_spec_end.get(2).getText().toString())< Integer.parseInt(et_spec_start.get(2).getText().toString()) || Integer.parseInt(et_spec_end.get(2).getText().toString())>1700)
                {
    ...
    private EditText.OnEditorActionListener section4_spec_end = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_end.get(3).getText().toString().matches("")|| Integer.parseInt(et_spec_end.get(3).getText().toString())< Integer.parseInt(et_spec_start.get(3).getText().toString()) || Integer.parseInt(et_spec_end.get(3).getText().toString())>1700)
                {
    ...
    private EditText.OnEditorActionListener section5_spec_end = new EditText.OnEditorActionListener()
    {
        ...
        public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) {
            if (actionId == EditorInfo.IME_ACTION_SEARCH ||
                    ...
                    event.getAction() == KeyEvent.ACTION_DOWN &&
                            event.getKeyCode() == KeyEvent.KEYCODE_ENTER) {
                if(et_spec_end.get(4).getText().toString().matches("")|| Integer.parseInt(et_spec_end.get(4).getText().toString())< Integer.parseInt(et_spec_start.get(4).getText().toString()) || Integer.parseInt(et_spec_end.get(4).getText().toString())>1700)
                {
    ...
    */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_save) {
            ...
            else
            {
                ...
                saveConfig = true;
                ScanConfActivity.saveConfig = saveConfig;
                SaveConfig(NIRScanConfigName);
                SaveConfig(NIRScanConfigNumRepeats);
                SaveConfig(NIRScanConfigNumSections);
                SaveConfig(NIRScanConfigType);
                SaveConfig(NIRScanConfigWidth);
                SaveConfig(NIRScanConfigStart_nm);
                SaveConfig(NIRScanConfigEnd_nm);
                SaveConfig(NIRScanConfigNumPattern);
    ...
    private void SaveConfig(int index)
    {
        ...
        total_section = Integer.parseInt(et_total_section.getText().toString());
        switch (index)
        {

            case NIRScanConfigType://may have five value for slew type
            {
                byte data[] = new byte[4+total_section];
                data[0] = (byte) 0xFF;
                data[1] = (byte) 0x81;
                data[2] = (byte) 0x02;
                data[3] = (byte) total_section;//payload lengthg
                for(int i=0;i<total_section;i++)
                {
                    data[4+i] = (byte)Integer.parseInt(et_type.get(i).getText().toString());
                }
            ...
            case  NIRScanConfigWidth:
            {
                ...
                data[1] = (byte) 0x85;
                data[2] = (byte) 0x02;
                data[3] = (byte) total_section;
                for(int i=0;i<total_section;i++)
                {
                    data[4+i] = (byte)Integer.parseInt(et_width.get(i).getText().toString());
                }
                quickset.putExtra(NIRScanSDK.QUICK_SET_VALUE, data);
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(quickset);
                break;
            ...
            {
                byte data[] = new byte[4+total_section*2];
                data[0] = (byte) 0xFF; //Command Start Flag
                data[1] = (byte) 0x83; //Command
                data[2] = (byte) 0x02; //Command Group
                data[3] = (byte) (total_section*2); //Payload length
                for(int i=0;i<total_section;i++)
                {
                    int start_nm_value = Integer.parseInt(et_spec_start.get(i).getText().toString());
                    data[4+i*2] = (byte)(start_nm_value);
                    data[5+i*2] = (byte)(start_nm_value>>8);
                }
                quickset.putExtra(NIRScanSDK.QUICK_SET_VALUE, data);
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(quickset);
                break;
            ...
            case NIRScanConfigEnd_nm:
            {
                ...
                for(int i=0;i<total_section;i++)
                {
                    int end_nm_value = Integer.parseInt(et_spec_end.get(i).getText().toString());
                    data[4+i*2] = (byte)(end_nm_value);
                    data[5+i*2] = (byte)(end_nm_value>>8);
                }
                quickset.putExtra(NIRScanSDK.QUICK_SET_VALUE, data);
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(quickset);
                break;
            ...
            case NIRScanConfigNumPattern:
            {
                ...
                for(int i=0;i<total_section;i++)
                {
                    int num_pattern_value = Integer.parseInt(et_res.get(i).getText().toString());
                    data[4+i*2] = (byte)(num_pattern_value);
                    data[5+i*2] = (byte)(num_pattern_value>>8);
                }
                quickset.putExtra(NIRScanSDK.QUICK_SET_VALUE, data);
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(quickset);
                break;
            ...
            case NIRScanConfigNumRepeats:
            {
                ...
                data[2] = (byte) 0x02;
                data[3] = (byte) 0x02;
                int num_repeat_value = Integer.parseInt(et_repeat_add.getText().toString());
            ...
            case NIRScanConfigExposureTime:
            {
                ...
                data[1] = (byte) 0x8D;
                data[2] = (byte) 0x02;
                data[3] = (byte) (total_section*2);
                for(int i=0;i<total_section;i++)
                {
                    int exposure_time_index = Integer.parseInt(et_exposure.get(i).getText().toString());
                    data[4+i*2] = (byte)(exposure_time_index);
                    data[5+i*2] = (byte)(exposure_time_index>>8);
                }
                quickset.putExtra(NIRScanSDK.QUICK_SET_VALUE, data);
                LocalBroadcastManager.getInstance(mContext).sendBroadcast(quickset);
                break;
            ...
            case NIRScanConfigName:
            {
                ...
                byte data[] = new byte[4+name_size];
                data[0] = (byte) 0xFF;
                data[1] = (byte) 0x89;
                data[2] = (byte) 0x02;
                byte[] midbytes=isoString.getBytes();
                data[3] = (byte) name_size;
    ...
    {
        passSpectrumCalCoefficients = NewScanActivity.passSpectrumCalCoefficients;
        ...
        MaxPattern = NewScanActivity.GetMaxPatternJNI(scan_type,start_nm,end_nm,width_index,num_repeat,passSpectrumCalCoefficients);
